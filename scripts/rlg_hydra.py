...
class Args:
    ...
    device:str = 'CPU'  # CPU or GPU for running physics
    ppo_device:str = 'CPU'  # whether to use GPU for inference with PPO
...
def launch_rlg_hydra(cfg: DictConfig):
    ...
    OmegaConf.update(cfg,"args[headless]",False)
    OmegaConf.update(cfg,"args[num_envs]",1)
    OmegaConf.update(cfg,"args[wandb_log]",False)
    # OmegaConf.update(cfg,"args[checkpoint]",'/home/wq/Documents/leibnizgym/rl_models/ppo_cube_noise.pth')
