...
import sys 
sys.path.append('/home/wq/Documents/leibnizgym/scripts')
# from trifinger_random_action import run
# import ppo_continuous_action_isaacgym 
import sac_predict
# import dt_predict
# import sacn_predict
# import cql_predict 
...
def run_rlg_hydra(hydra_cfg):
    ...
    if cli_args.play==True:
        print("start play")
        if cli_args.offline:
            #sacn_predict.play(hydra_cfg)
            dt_predict.play(hydra_cfg)
            #cql_predict.play(hydra_cfg)
        else:
            # sac_predict.play(hydra_cfg)
            # ppo_continuous_action_isaacgym.play(hydra_cfg)
            sac_predict.test(hydra_cfg)
